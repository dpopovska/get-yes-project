...
<div class="content-wrapper">
	...
	<div class="main-content-wrapper">
		...
		<div class="mc-titlebar">
			<span class="mc-title control-panel">Add new member</span>
		</div>
				...
				<div class="col-6">
					...
					<div class="widget red">
						...
						<div class="widget-content-wrapper">
							...
							{!! Form::open(array('url' => URL::to('about'), 'method' => 'POST', 'class'=>'default-form', 'files' => true)) !!}
								@include('about-page.form', ['buttonName'=>'Create'])
							{!! Form::close() !!}
							</div>
						</div>
